...
import preloader, { preloadBiscuit } from '../preloader/actions';
...
export const biscuitActions = _.assign({}, decorators, forms, { preload: preloadBiscuit }, reactiveRender, components, pages, pageState, toolbar, deepLinking, validators, undo, lists, drawers, nav, layout);
