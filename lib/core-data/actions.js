...
import preloader, { biscuitPreloader } from '../preloader/actions';
...
import * as layout from '../layout-state/actions';

const actions = _.assign({}, decorators, forms, { preload: preloader }, reactiveRender, components, pages, pageState, toolbar, deepLinking, validators, undo, lists, drawers, nav, layout);
export const biscuitActions = _.assign({}, decorators, forms, { preload: biscuitPreloader }, reactiveRender, components, pages, pageState, toolbar, deepLinking, validators, undo, lists, drawers, nav, layout);
