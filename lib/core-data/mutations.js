...
export const biscuitMutations = _.assign({}, preloader, pageData, pageState, decorators, forms, components, toolbar, deepLinking, validators, undo, lists, drawers, nav, layout, _.reduce(vanityMutations, (obj, name) => _.assign(obj, { [name]: vanityFunction }), {}));
